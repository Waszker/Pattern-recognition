...
When comparing highlights and drawbacks of each method, from computational complexity, ease of testing point inclusion and algorithm implementation point of view, ellipsoids seem very reasonable to choose.
...
Not only does it satisfy 
$1/dMVEE(A) \subset conv(A) \subset MVEE(A) $
