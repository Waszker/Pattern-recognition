...
{\color{green}Elipsoidy: ??? 
	SVM: gamma=0.125, c=16, jadro: rbf
	KNN: K=4
	RF: liczba drzew=100 }
...
SVM method available in Scikit package offers some built-in kernel that were used in computations: rbf and polynomial. Additionally, there are two more parameters that were tested: C (described as penalty parameter C of the error term), and $\gamma$ (known as kernel coefficient). Values that were tested:
\begin{itemize}
