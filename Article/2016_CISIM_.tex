...
According to our studies, certain classifiers (such as SVM method) have above 0.9 success rate which makes them great tool for recognizing classes of native elements, assuming that there are no foreign elements to classify. To maintain this assumption we introduced ellipsoids as identifiers that will reject non-native elements.
